  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-1/4 right-10 bg-[#DFE9F4] p-6 rounded max-w-md shadow-lg">
        ...
        <a href="#"><button className="bg-[#054C73] text-white text-xs px-9 py-3 rounded-full hover:bg-blue-600 transition">
          BUY NOW
        </button></a>
      </div>

      {/* Beneficios */}
      <div className="bg-[#F2F5FF] flex flex-wrap justify-around gap-6 py-8 px-4">
        {/* Card 1 */}
